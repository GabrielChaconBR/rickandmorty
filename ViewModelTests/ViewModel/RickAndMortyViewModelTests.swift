...
extension RickAndMortyViewModelTests {
    ...
    //func makeSut(delegate: SplashViewModelProtocolSpy, getRickAndMortySpy: GetRickAndMortySpy = GetRickAndMortySpy(), file: StaticString = #file, //line: UInt = #line) -> RickAndMortyViewModel {
